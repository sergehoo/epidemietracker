# Generated by Django 4.2.15 on 2025-06-10 11:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_application', models.ForeignKey(blank=True, help_text="Nom de l'application ayant envoyé le signalement.", null=True, on_delete=django.db.models.deletion.SET_NULL, to='epidemie.platform')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, max_length=100, unique=True)),
                ('poles', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='regions', to='epidemie.polesregionaux')),
            ],
        ),
        migrations.AddField(
            model_name='epidemie',
